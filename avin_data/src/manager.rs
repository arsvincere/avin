...
impl Manager {
    ...
    pub async fn download(
        ...
        let result = match md {
            ...
            MarketData::BAR_DAY => Self::download_bar(iid, md, year).await,
            MarketData::BAR_WEEK => Self::download_bar(iid, md, year).await,
            MarketData::BAR_MONTH => Self::download_bar(iid, md, year).await,
        ...
        match md {
            ...
            MarketData::BAR_DAY => DataBar::save(iid, md, df),
            MarketData::BAR_WEEK => DataBar::save(iid, md, df),
            MarketData::BAR_MONTH => DataBar::save(iid, md, df),
