...
- **data:** загрузка и обновление исторических данных. Пока только с
  Московской биржи
- **filter:** поиск определенных условий на графике
...
все на Rust. Это даст бОльшую надежность кода и лучшую производительность, по
сравнению с реализацией на Python. В перспективе библиотека может использоваться
и для создания HFT стратегий.

Программа на этапе активной разработки. Пока работоспособна только "для себя",
мало документации, часто меняются интерфейсы. На сегодня (2025-10-23)
переписана основная часть Python кода. Остается сделать GUI, но с этим
возникли непредвиденные трудности. Для Rust нет зрелых GUI фреймворков как Qt.
Есть Iced и egui/eframe, но они еще младенцы. Сейчас пытаюсь освоить
html css js и сделать GUI на веб-технологиях через Tauri.
