...
from src_py.utils import Cmd, dt_to_ts, log, now, prev_month
...
class SourceMoex:
    ...
    def __correct_end_dt(
        ...
        # Когда запрос get_bars идет с first || last_stored, до now().
        # Или когда в запросе время end больше настоящего времени...
        # Например скачать в 2025г свечи за [2025-01-01, 2026-01-01].
        # надо еще отбросить текущую незавершенную свечу
