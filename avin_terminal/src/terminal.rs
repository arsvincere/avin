...
fn create_header() -> iced::widget::Row<'static, Message> {
    widget::row![
        widget::text("Ticker").size(HEADER).width(TICKER),
        widget::text("A").size(HEADER).width(ACTIVE),
        widget::text("Day").size(HEADER).width(DAY),
        widget::text("1M-1").size(HEADER).width(TFT__),
        widget::text("1M-2").size(HEADER).width(TFT__),
        widget::text("1M-3").size(HEADER).width(TFT__),
        widget::text("1M-4").size(HEADER).width(TFT__),
        widget::text("1M-5").size(HEADER).width(TFT_L),
        widget::text("10M-1").size(HEADER).width(TFT__),
        widget::text("10M-2").size(HEADER).width(TFT__),
        widget::text("10M-3").size(HEADER).width(TFT__),
        widget::text("10M-4").size(HEADER).width(TFT__),
        widget::text("10M-5").size(HEADER).width(TFT_L),
        widget::text("1H-1").size(HEADER).width(TFT__),
        widget::text("1H-2").size(HEADER).width(TFT__),
        widget::text("1H-3").size(HEADER).width(TFT__),
        widget::text("1H-4").size(HEADER).width(TFT__),
        widget::text("1H-5").size(HEADER).width(TFT_L),
        widget::text("D-1").size(HEADER).width(TFT__),
        widget::text("D-2").size(HEADER).width(TFT__),
        widget::text("D-3").size(HEADER).width(TFT_L),
    ]
    .spacing(10)
}
